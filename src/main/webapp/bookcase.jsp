...
<table width="778"  border="0" cellspacing="0" cellpadding="0" align="center">
 ...
 <c:choose>
    <c:when test="${empty applicationScope.bookcase}">
    ...
    <c:otherwise>
      ...
      <c:forEach items="${applicationScope.bookcase}" var="bookcase">
        <tr>
            ...
            <td align="center"><a href="#" onClick="window.open('Servlet?method=bookCaseModifyQuery&ID=${bookcase.id}','','width=292,height=175')">修改</a></td>
            <td align="center"><a href="Servlet?method=bookCaseDel&ID=${bookcase.id}">删除</a></td>
          </tr>
