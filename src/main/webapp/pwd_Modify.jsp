...
<table width="778"  border="0" cellspacing="0" cellpadding="0" align="center">
 ...
 <table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <table width="47%"  border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#D2E3E6" bordercolorlight="#FFFFFF">
    <input name="method" type="hidden" id="1" value="modifypwd">
  <tr align="center">
    <td width="27%" align="left" style="padding:5px;">管理员名称：</td>
    <td width="73%" align="left">
      <input name="id" type="hidden" id="" value="${applicationScope.manger.id}">
      <input name="name" type="text" id="name" value="${applicationScope.manger.name}" readonly="yes" size="30">    </td>
    <tr>
    <td align="left" style="padding:5px;">原密码：</td>
    <td align="left"><input name="oldpwd" type="password" id="oldpwd" size="30">
      <input name="holdpwd" type="hidden" id="holdpwd" value="${applicationScope.manger.PWD}"></td>
    </tr>
    <tr>
