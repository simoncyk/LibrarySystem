        ...
        <td height="72" align="center" valign="top" background="Images/main_booksort_1.gif" bgcolor="#F8BF73"><table width="96%" border="0" cellpadding="1" cellspacing="1" bordercolor="#F8BF73">
          <tr>
            <td valign="top" bgcolor="#F8BF73">
				...
				<form name="form1" method="post" action="Servlet">
                    <input type="hidden" name="method" value="bookRenewQuery"  style="display:none" >
                  <tr>
                    <td><table width="90%" height="21" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td width="76%" style="padding-top:7px;">读者条形码：
                            <input name="readerbarcode" type="text" id="barcode" value="${readermsg.barcode}" size="24">
                            &nbsp;
                  ...
                  <tr>
                    <td align="center"><table width="96%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td height="27">姓&nbsp;&nbsp;&nbsp;&nbsp;名：
                            <input name="readername" type="text" id="readername" value="${readermsg.name}"></td>
                          <td>性&nbsp;&nbsp;&nbsp;&nbsp;别：
                            <input name="sex" type="text" id="sex" value="${readermsg.sex}"></td>
                          <td>读者类型：
                            <input name="readerType" type="text" id="readerType" value="${readermsg.readertypename}"></td>
                        </tr>
                        <tr>
                          <td height="27">证件类型：
                            <input name="paperType" type="text" id="paperType" value="${readermsg.paperType}"></td>
                          <td>证件号码：
                            <input name="paperNo" type="text" id="paperNo" value="${readermsg.paperNO}"></td>
                          <td>可借数量：
                            <input name="number" type="text" id="number" value="${readermsg.number}" size="17">
                            册
                            &nbsp;</td>
                        </tr>
                    </table></td>
          ...
          <tr>
            <td valign="top"><table width="100%" height="35" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#F6B83B" bgcolor="#FFFFFF">
               ...
               <c:if test="${!empty applicationScope.readerborrowmsg}">
                    <c:forEach items="${applicationScope.readerborrowmsg}" var="readerborrowmsg">
                   <tr>
                     <td height="25" style="padding:5px;">&nbsp;${readerborrowmsg.bookname}</td>
                     <td style="padding:5px;">&nbsp;${readerborrowmsg.borrowTime}</td>
                     <td style="padding:5px;">&nbsp;${readerborrowmsg.backTime}</td>
                     <td align="center">&nbsp;${readerborrowmsg.pubname}</td>
                     <td align="center">&nbsp;${readerborrowmsg.bookcasename}</td>
                     <td width="13%" align="center">&nbsp;${readerborrowmsg.price}</td>
                     <td width="12%" align="center"><a href="Servlet?method=bookrenew&readerbarcode=${readerborrowmsg.readerbarcode}&id=${readerborrowmsg.id}">续借</a>&nbsp;</td>
                   </tr>
                  </c:forEach>
               </c:if>
            </table>
