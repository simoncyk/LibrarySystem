	...
	<table width="600" height="432"  border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      <tr>
        ...
        <td width="427" height="39">
          <input name="name" type="text" value="${readermsg.name}"> </td>
      </tr>
      <tr>
        <td width="173" height="30" align="center">性&nbsp;&nbsp;&nbsp;&nbsp;别：</td>
        <td height="35"><input name="name" type="text" value="${readermsg.sex}"></td>
      </tr>
      <tr>
        <td height="30" align="center">条&nbsp;形&nbsp;码：</td>
        <td><input name="barcode" type="text" id="barcode" value="${readermsg.barcode}"></td>
      </tr>
      <tr>
        <td height="30" align="center">读者类型：</td>
        <td><input name="vocation" type="text" id="vocation" value="${readermsg.readertypename}"></td>
      </tr>
      <tr>
        <td height="30" align="center">职&nbsp;&nbsp;&nbsp;&nbsp;业：</td>
        <td><input name="vocation" type="text" id="vocatio" value="${readermsg.vocation}"></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><input name="paperType" type="text" value="${readermsg.paperType}"></td>
      </tr>
      <tr>
        <td height="30" align="center">证件号码：</td>
        <td><input name="paperNO" type="text" id="paperNO" value="${readermsg.paperNO}"></td>
      </tr>
      <tr>
        <td height="30" align="center">登记日期：</td>
        <td><input name="paperNO2" type="text" id="paperNO2" value="${readermsg.createDate}"></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><input name="operator" type="text" id="operator" value="${readermsg.operator}">
          </td>
      </tr>	  
      <tr>
