    ...
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td><table width="100%" height="131"  border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td align="center">	<form name="form1" method="post" action="<%=request.getContextPath()%>/Servlet">
	<table height="100"  border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      <input name="method" type="hidden" size="30"  value="bookTypeAdd">
      <tr>
        <td width="77" align="center">类型名称：</td>
        <td width="198" height="39"><input name="typeName" type="text" size="30"></td>
      </tr>
      <tr>
        <td width="77" align="center">可借天数：</td>
        <td height="35"><input name="days" type="text" id="days" size="25">(天)</td>
      </tr>
      <tr>
        <td align="center">&nbsp;</td>
