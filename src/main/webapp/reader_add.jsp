...
<c:if test="${empty applicationScope.readerType}"> <script>alert('请先录入读者类型信息!');history.back(-1);</script>  </c:if>
...
<table width="778"  border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
	...
	<table width="600" height="432"  border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
        <input name="method" type="hidden" id="readerAdd" value="readerAdd">
      <tr>
