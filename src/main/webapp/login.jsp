                ...
                <td width="2%">&nbsp;</td>
                  <td width="97%" align="center" valign="top">
                    <form name="form1" method="post" action="Servlet" >
                      ...
                      <input type="hidden" name="method" value="login"  style="display:none" >
                      <table width="100%"  border="0" cellpadding="0" cellspacing="0" bordercolorlight="#FFFFFF" bordercolordark="#D2E3E6">
                        <tr>
                          <td height="57">&nbsp;</td>
                          <td height="57" colspan="2" align="center"  style="padding:0px;"><p style="color:red; margin-top:50px; font-size:16px;" align="center">${msg}</p></td>
                          <td>&nbsp;</td>
                        </tr> 
                        <tr>
                      ...
                      <td width="31%">
                        <input name="mamgername" type="text" class="logininput" id="name" size="27">                        </td>
                      <td width="9%">&nbsp;</td>
                    </tr>
                        <tr>
                          <td height="37">&nbsp;</td>
